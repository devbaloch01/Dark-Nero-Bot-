...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER.split("923461253726,")
...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://telegra.ph/file/9eb66a3e2fc0011400637.jpg'
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'A B Abubakar Baloch' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'devbaloch' : process.env.OWNER_NAME,
  ...
  packname:  process.env.PACK_INFO.split(";")[1] === undefined ? '👇🏻


_Subscribe Channel_
https://youtube.com/watch?v=umb89KBUANc

_WhatApp Bot Create_
https://youtube.com/watch?v=3nRlAHMJuOg' : process.env.PACK_INFO.split(";")[1],	
...
_WhatApp Bot Create_
https://youtube.com/watch?v=3nRlAHMJuOg",
  ...
  LANG: process.env.THEME|| 'devnaloch',
